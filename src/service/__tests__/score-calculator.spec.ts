...
describe('ScoreCalculatorImpl', () => {
    ...
    const getScoreCalculatorImpl = () => appContainer.get<ScoreCalculator>(SERVICE_TYPES.ScoreCalculator);

    describe('countScores', () => {
        let scores: string[] = [];

        beforeEach(() => {
            scoreCalculator = getScoreCalculatorImpl();
            scores = ['a', 'a', 'a', 'b'];
        });
